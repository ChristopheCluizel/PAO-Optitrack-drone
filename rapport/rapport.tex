...
\author{Alexandre \bsc{Brehmer}\\ Christophe \bsc{Cluizel}\\ Encadrant: M. Guerrero}
\renewcommand\soustitre{Rapport de projet}
\renewcommand\infoBig{Projet d'Approfondissement et d'Ouverture}
\renewcommand\infoSmall{ASI4 2014-2015 \\ Semestre 8}
...
\newpage
\include{2.presentation_systeme_optitrack_ardrone}
\newpage
\include{3.objectif_pao}
\newpage
\include{4.calendrier}
\newpage
\include{5.suivi_de_projet}
\newpage
\include{6.tutoriel}
\newpage
\include{7.realisation_logicielle}
\newpage
\include{8.perspective}
\newpage
